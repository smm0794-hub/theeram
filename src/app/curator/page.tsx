  ...
  return (
    <div style={{ minHeight: '100vh', background: C.cream }}>
      ...
      <div style={{ padding: '12px 16px 4px' }}>
        <div style={{ ...sans, fontSize: 9, color: C.muted, letterSpacing: '.08em', marginBottom: 6 }}>SPACES</div>
      ...
      <div style={{ padding: '8px 16px 4px' }}>
        <div style={{ ...sans, fontSize: 9, color: C.muted, letterSpacing: '.08em', marginBottom: 6 }}>MAKERS</div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
          {[
