...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Theeram Spaces - Event Venues and Villas in Kerala',
    template: '%s | Theeram Spaces Kerala',
  },
  description: 'A hand-curated directory of event spaces, villas, and venues across Kerala. Weddings, family gatherings, corporate events. No booking fees. Talk directly to owners on WhatsApp.',
  keywords: ['event space Kerala', 'wedding venue Kerala', 'party hall Kerala', 'villa for rent Kerala', 'event venue Pala', 'wedding venue Pala Kottayam', 'event space Thodupuzha', 'party hall Kanjirappally'],
